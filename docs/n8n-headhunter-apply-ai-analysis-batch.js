...
return inputs.map((item, index) => {
  ...
  // Only Smart Match (match_score) + insights are produced. The verbose
  // ai_analysis paragraph is intentionally no longer generated; sent empty
  // to keep the downstream payload shape stable.
  return {
    json: {
      ...rest,
      match_score,
