        ...
        if (validateForm()) {
            ...
            try {
                ...
                if (result.success && result.campaignId) {
                    ...
                    const errorMessage = result.message || result.error || 'Failed to create campaign. Please try again.';
                    alert(`Error creating campaign: ${errorMessage}`);
                }
            } catch (error) {
                console.error('❌ Error creating campaign:', error);
                const errorMessage = error.message || 'Error creating campaign. Please try again.';
                alert(`Error creating campaign: ${errorMessage}`);
            } finally {
