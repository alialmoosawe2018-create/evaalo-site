...
import { getLLMResponse, getTimeEndedClosingMessage, getTimeEndedApologyMessage, getInitialGreetingMessage, evaluateVoiceInterview, type InterviewPhase } from "../services/llmService.js";
...
export function handleVoiceWsConnection(ws: WebSocket, req: IncomingMessage) {
  ...
  console.log(`[SESSION START] ${sessionId.substring(0, 8)}... candidateId: ${candidateId || "none"} language: ${language || "auto"}`);
