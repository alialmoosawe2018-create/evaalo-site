...
function completeStage2VoiceBody(extra?: Record<string, unknown>): Record<string, unknown> {
    return {
        ...
        problem_solving: 7,
        digital_skills: 'Comfortable with CRM tools',
        professional_attitude: 'Polite and engaged',
...
async function testUnsetGateModeObserveIncompletePersisted(): Promise<void> {
...
async function main(): Promise<void> {
    ...
    await testUnsetGateModeObserveIncompletePersisted();
    console.log('✓ unset gate mode → observe; incomplete callback persisted');
