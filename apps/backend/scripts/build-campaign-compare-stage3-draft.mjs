...
import {
    ...
    PREPARE_LLM_CODE,
    VALIDATE_CODE,
} from './campaign-compare-stage3-phase15-prompt.mjs';
...
const prepareLlmCode = PREPARE_LLM_CODE;
...
const workflow = {
    ...
    description:
        'Secure Campaign Compare Stage 3 (Phase 1.5): dual llm/callback context, chainLlm response parsing, signed callback, email_dispatch_only branch.',
    active: false,
    nodes: [
        {
