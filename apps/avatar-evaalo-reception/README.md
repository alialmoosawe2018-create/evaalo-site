# LiveKit Agents Starter - Python · **Evaalo Reception fork**

This folder (`avatar-evaalo-reception`) runs the **`evaalo-reception-agent`** worker for the public **`/demo`** flow (`/api/reception-demo/*`). It shares stacks with Evaalo's interview agent but **has no candidate DB or question bank**.

See repo root plan / `README.md` sections below for LiveKit CLI and deployment.
